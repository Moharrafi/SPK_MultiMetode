...
const translations: Translations = {
  ...
  "toast.name_min_length": { id: "Nama minimal 3 karakter", en: "Name must be at least 3 characters" },
  "toast.passwords_dont_match": { id: "Password tidak cocok", en: "Passwords do not match" },
}
