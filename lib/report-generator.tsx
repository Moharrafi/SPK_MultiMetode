...
import { defaultReportSettings } from "./settings-data"
...
function resolveReportSettings(override?: Partial<ReportSettings>): ReportSettings {
  if (override) {
    return { ...defaultReportSettings, ...override }
  }
