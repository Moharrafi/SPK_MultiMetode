...
function SPKProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SPKProvider.useEffect": ()=>{
            const load = {
                "SPKProvider.useEffect.load": async ()=>{
                    try {
                        ...
                        setAlternatif(data.alternatif.map({
                            "SPKProvider.useEffect.load": (item)=>({
                                    ...item,
                                    createdAt: item.createdAt ? new Date(item.createdAt) : new Date()
                                })
                        }["SPKProvider.useEffect.load"]));
                        setKriteria(data.kriteria.map({
                            "SPKProvider.useEffect.load": (item)=>({
                                    ...item,
                                    createdAt: item.createdAt ? new Date(item.createdAt) : new Date()
                                })
                        ...
                        setMetodeConfig(data.metodeConfig);
                        setPairwiseComparisons(data.pairwiseComparisons);
                    } catch (error) {
                        console.error(error);
                    }
                }
    ...
    const request = async (path, init)=>{
        try {
            ...
            if (!response.ok) {
                console.warn(`[SPK] request failed for ${path}: ${response.status}`);
                showToast("Gagal terhubung ke server. Periksa koneksi database dan coba lagi.", "error");
                return null;
            }
            return await response.json();
        } catch (error) {
            console.warn(`[SPK] request error for ${path}`, error);
            showToast("Gagal terhubung ke server. Periksa koneksi database dan coba lagi.", "error");
            return null;
        }
    };
    const addAlternatif = (data)=>{
        void request("/api/alternatif", {
            method: "POST",
    ...
    const updateAlternatif = (id, data)=>{
        void request(`/api/alternatif/${id}`, {
            method: "PUT",
            body: JSON.stringify(data)
        }).then((updated)=>{
            if (!updated) return;
    ...
    const updateSubKriteria = (id, data)=>{
        void request(`/api/sub-kriteria/${id}`, {
            method: "PUT",
            body: JSON.stringify(data)
        }).then((updated)=>{
            if (!updated) return;
            setSubKriteria((prev)=>prev.map((s)=>s.id === id ? updated : s));
        }).catch((error)=>console.error(error));
    };
    ...
    const updatePenilaian = (alternatifId, kriteriaId, nilai)=>{
        void request("/api/penilaian", {
            ...
            if (!updated) return;
            setPenilaian((prev)=>{
                const exists = prev.some((p)=>p.alternatifId === alternatifId && p.kriteriaId === kriteriaId);
                if (exists) {
                    return prev.map((p)=>p.alternatifId === alternatifId && p.kriteriaId === kriteriaId ? updated : p);
                }
                return [
                    ...prev,
                    updated
    ...
    const toggleMetode = (nama)=>{
        const current = metodeConfig.find((m)=>m.nama === nama);
        if (!current) return;
        const nextAktif = !current.aktif;
        setMetodeConfig((prev)=>prev.map((m)=>m.nama === nama ? {
                    ...m,
                    aktif: nextAktif
                } : m));
        void request(`/api/metode-config/${nama}`, {
            method: "PATCH",
            body: JSON.stringify({
                aktif: nextAktif
            })
            ...
            if (!updated) return;
            setMetodeConfig((prev)=>prev.map((m)=>m.nama === nama ? updated : m));
        }).catch((error)=>console.error(error));
    };
    ...
    const updatePairwiseComparison = (kriteria1Id, kriteria2Id, nilai)=>{
        void request("/api/pairwise-comparisons", {
            method: "POST",
            body: JSON.stringify({
                kriteria1Id,
                kriteria2Id,
            ...
            setPairwiseComparisons((prev)=>{
                const exists = prev.some((p)=>p.kriteria1Id === kriteria1Id && p.kriteria2Id === kriteria2Id);
                if (exists) {
                    return prev.map((p)=>p.kriteria1Id === kriteria1Id && p.kriteria2Id === kriteria2Id ? updated : p);
                }
                return [
                    ...prev,
                    updated
...
_s(SPKProvider, "QJI7vQHYQT2iiu7zc//0Ag9eSOs=", false, function() {
    return [
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuTrigger"], {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white font-semibold",
                                                children: user?.nama?.charAt(0).toUpperCase() || "U"
                                            }, void 0, false, {
                                                fileName: "[project]/components/layout/header.tsx",
                                                lineNumber: 72,
                                                columnNumber: 17
...
//# sourceMappingURL=_68e41c08._.js.map