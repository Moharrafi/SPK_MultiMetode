...
"[project]/lib/settings-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SettingsProvider({ children }) {
    const defaults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDefaultSettings"])();
    const [dashboardWidgets, setDashboardWidgets] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultDashboardWidgets"]);
    const [backupSettings, setBackupSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultBackupSettings"]);
    const [reportSettings, setReportSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultReportSettings"]);
    const [appSettings, setAppSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultAppSettings"]);
    ...
    const applySettingsSnapshot = (snapshot)=>{
        ...
        if (snapshot.backupSettings) {
            let mergedBackup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deserializeBackupSettings"])(snapshot.backupSettings);
            if (mergedBackup.enabled && !mergedBackup.nextBackup) {
                mergedBackup = {
                    ...mergedBackup,
                    nextBackup: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateNextBackup"])(mergedBackup.frequency)
                };
            }
        ...
        switch(key){
            ...
            case "backupSettings":
                setBackupSettings((prev)=>{
                    const updated = updater(prev);
                    void persistSetting("backupSettings", (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serializeBackupSettings"])(updated));
                    cacheSettingsSnapshot({
    ...
    const updateBackupSettings = (settings)=>{
        guardedUpdate("backupSettings", (prev)=>{
            ...
            if (settings.frequency && settings.frequency !== prev.frequency) {
                updated.nextBackup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateNextBackup"])(settings.frequency);
            }
            if (updated.enabled && !updated.nextBackup) {
                updated.nextBackup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateNextBackup"])(updated.frequency);
            }
            if (!updated.enabled) {
    ...
    const performBackup = async (options)=>{
        try {
            ...
            guardedUpdate("backupSettings", (prev)=>({
                    ...
                    nextBackup: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$settings$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateNextBackup"])(prev.frequency, backupTime)
                }));
            if (options?.download) {
                const blob = new Blob([
...
//# sourceMappingURL=%5Broot-of-the-server%5D__db937809._.js.map