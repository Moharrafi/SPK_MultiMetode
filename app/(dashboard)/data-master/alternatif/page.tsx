...
export default function AlternatifPage() {
  ...
  const nextAlternatifCode = useMemo(() => {
    const existing = alternatif.map((a) => a.kode)
          ...
          <Table className="table-fixed">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-40">Nomor HP</TableHead>
                <TableHead className="w-[26%]">Alamat</TableHead>
                <TableHead className="w-28">Kategori</TableHead>
                {(canEdit || canDelete) && <TableHead className="w-24">Aksi</TableHead>}
              </TableRow>
            </TableHeader>
            <TableBody>
