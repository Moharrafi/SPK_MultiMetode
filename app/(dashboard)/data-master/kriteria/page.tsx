...
export default function KriteriaPage() {
  ...
  const nextKriteriaCode = useMemo(() => {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                {(canEdit || canDelete) && <TableHead className="w-28">Aksi</TableHead>}
              </TableRow>
            </TableHeader>
            <TableBody>
              {kriteria.map((krit, idx) => (
                <TableRow key={krit.id}>
                  ...
                  <TableCell className="text-foreground">{krit.nama}</TableCell>
                  <TableCell>{krit.bobot.toFixed(2)}</TableCell>
                  <TableCell>
                    <Badge
                      className={
                        krit.jenis === "benefit"
