          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="font-medium text-foreground">Keterangan</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {skalaAHP.map((skala) => (
                <TableRow key={skala.nilai}>
                  ...
                  <TableCell className="text-foreground">{skala.keterangan}</TableCell>
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              <TableRow>
                <TableCell>
                  <Badge className="text-sm">5</Badge>
                </TableCell>
                <TableCell>Sangat Baik</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                  <Badge className="text-sm">4</Badge>
                </TableCell>
                <TableCell>Baik</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                  <Badge className="text-sm">3</Badge>
                </TableCell>
                <TableCell>Cukup</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                  <Badge className="text-sm">2</Badge>
                </TableCell>
