...
export default function LaporanPage() {
  ...
  const { reportSettings } = useSettings()
  ...
  const handleExport = async (reportType: string, format: "excel" | "pdf") => {
    ...
    try {
      ...
      if (format === "excel") {
        ...
        generatePDFReport(data, reportType, reportSettings)
    ...
    try {
      ...
      for (const type of reportTypes) {
        ...
        if (format === "excel") {
          ...
          generatePDFReport(data, type, reportSettings)
        }
      }

      logActivity(
        format === "excel" ? "activity.report_exported_all_excel" : "activity.report_exported_all_pdf",
      )
      showToast({
